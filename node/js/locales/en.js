...
export default {
    ...
    'apps.journal.seal-lock-this-entry-unlocking': 'Seal — lock this entry (unlocking takes 15 seconds)',
    'apps.journal.delete-removes-this-entry-its': 'Delete — removes this entry (its history is kept)',
    ...
    'apps.people.type-to-narrow-the-shelf': 'type to narrow the shelf; paste an address and look up to go there',
    ...
    'person.trust': 'trust',
    'person.who-can-see-my-trust': 'who can see my trust',
    'person.sharing-your-trust-information-helps': 'sharing your trust information helps the network grow, but gives up some of your privacy!',
