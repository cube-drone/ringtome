...
mod tests {
    ...
    async fn a_room_chain_travels_on_its_lane_or_between_own_computers() {
        ...
        let room = [7u8; 16];
        let msg = ringtome_proto::registry::ChatMessage { room_author: [9u8; 32], body: b"hi".to_vec(), sealed: false, refs: Vec::new(), mentions: Vec::new(), reacts_to: None, retracts: None };
